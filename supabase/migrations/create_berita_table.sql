...
('sosialisasi-orienteering-sma-dki', 'Sosialisasi Orienteering di Sekolah Menengah Atas DKI Jakarta', 'FONI Pengprov DKI Jakarta memulai program "Orienteering Goes to School" untuk mengenalkan olahraga cerdas ini ke kalangan pelajar menengah atas.', '<p>Program "Orienteering Goes to School" bertujuan untuk menjaring bibit-bibit atlet muda potensial dari tingkat sekolah. Tim FONI Pengprov DKI Jakarta mengunjungi berbagai SMA di 5 wilayah kota administrasi untuk memberikan edukasi dasar mengenai navigasi darat, pengenalan kompas, dan simulasi mini orienteering di area sekolah. Program ini diharapkan dapat mencetak generasi baru atlet orienteering berprestasi.</p>', 'Sosialisasi', 'https://images.unsplash.com/photo-1524661135-423995f22d0b?q=80&w=2074&auto=format&fit=crop', false, '2025-08-15 13:00:00+07'),
('pemutakhiran-peta-hutan-kota-srengseng', 'Pemutakhiran Peta Hutan Kota Srengseng Rampung', 'Kabar gembira bagi para orienteer, peta Hutan Kota Srengseng telah diperbarui dengan standar ISSprOM terbaru dan siap digunakan untuk latihan.', '<p>Proses pemutakhiran peta Hutan Kota Srengseng memakan waktu kurang lebih dua bulan. Tim pemetaan FONI Pengprov DKI Jakarta bekerja keras melakukan survei ulang secara menyeluruh untuk memastikan akurasi data vegetasi, kontur tanah, dan fitur buatan manusia. Peta terbaru ini telah menggunakan standar ISSprOM 2019-2 dan dapat diunduh secara gratis oleh anggota klub terdaftar.</p>', 'Pemetaan', 'https://images.unsplash.com/photo-1473448912268-2022ce9509d8?q=80&w=2041&auto=format&fit=crop', false, '2025-08-02 15:00:00+07')
