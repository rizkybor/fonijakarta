        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-foni-orange hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/profil" className="hover:text-foni-orange transition-colors">Profil Pengurus</Link>
              </li>
              <li>
