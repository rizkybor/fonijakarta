  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 pt-24">
      <div className="max-w-md w-full bg-white rounded-3xl p-8 md:p-12 shadow-xl shadow-slate-200/50 border border-slate-100 text-center relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-[var(--color-foni-orange)]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-[var(--color-foni-navy)]/5 rounded-full blur-3xl"></div>

        <div className="relative z-10">
          <div className="relative w-32 h-32 mx-auto mb-8">
            <div className="absolute inset-0 bg-[var(--color-foni-navy)]/5 rounded-full animate-ping"></div>
            <div className="absolute inset-2 bg-white rounded-full shadow-lg flex items-center justify-center border-4 border-slate-50">
              <Compass className="w-12 h-12 text-[var(--color-foni-orange)]" />
            </div>
            <div className="absolute -bottom-2 -right-2 w-10 h-10 bg-white rounded-full shadow-md flex items-center justify-center">
              <Map className="w-5 h-5 text-[var(--color-foni-navy)]" />
            </div>
          </div>
          ...
          <Link 
            href="/"
            className="inline-flex items-center justify-center gap-2 bg-[var(--color-foni-navy)] text-white px-8 py-4 rounded-full font-bold hover:bg-[var(--color-foni-stardust)] hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-[var(--color-foni-navy)]/30 w-full"
          >
